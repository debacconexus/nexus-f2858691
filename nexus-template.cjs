...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Officer-Involved Shooting Accountability Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Officer-Involved Shooting Incident";
process.env.TABLE_NAME = process.env.TABLE_NAME || "officer_involved_shooting_incident_records";
'use strict';
